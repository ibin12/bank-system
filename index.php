...
<html lang="en">
  ...
  <div style="background-color:#ffff;">
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background: #e28b09">
      ...
      <footer class="text-center mt-5 py-2" style="background-color:black;font-color:white;">
        <p>&copy 2021. Made by <b>IBIN</b> <br>SPARKS Foundation</p>
      </footer>
